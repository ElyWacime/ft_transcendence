/*
  ...
  - Added the required column `score_player1` to the `Match` table without a default value. This is not possible if the table is not empty.
  - Added the required column `score_player2` to the `Match` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Match" ("Ball_x", "Ball_y", "CreatedAt", "P1_Id", "P2_Id", "UpdatedAt", "Winner_Id", "id", "result", "tournamentId") SELECT "Ball_x", "Ball_y", "CreatedAt", "P1_Id", "P2_Id", "UpdatedAt", "Winner_Id", "id", "result", "tournamentId" FROM "Match";
DROP TABLE "Match";
